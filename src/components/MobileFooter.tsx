...
export default function MobileFooter() {
  return (
    <div className="flex flex-col flex-1 w-full mx-auto">
      ...
      <div className="flex flex-row items-center gap-6 w-full justify-center mt-[40px]">
        <svg
          width="32"
          height="32"
          viewBox="0 0 24 24"
      ...
      <div className="flex flex-col justify-center items-center mt-[50px]">
        ...
        <p className="text-[#626262] text-sm mt-5 text-center">
          © 2025 Mimos.
          <br /> All rights reserved.
        </p>
      </div>
      <div className="flex justify-center items-center mt-[50px]">
        <Image src={MimosLogo} alt="" className="z-20 max-w-[90%]" />
      </div>
    </div>
  );
}
